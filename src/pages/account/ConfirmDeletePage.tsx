...
export function ConfirmDeletePage() {
	usePageTitle('Confirmar eliminación - Pistis');
	...
	return (
		<Layout>
			<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
				<img src="/thinking.png" alt="Pensando" className="w-40 h-40 mx-auto mb-4 object-contain" />

				<h2 className="text-xl font-semibold text-gray-900 mb-2 text-center">Confirmar eliminación de cuenta</h2>

				<div className="bg-gray-50 rounded-md p-4 my-6">
					<h3 className="font-medium text-gray-900 mb-2">Información sobre tus datos:</h3>
					<div className="text-gray-600 text-sm whitespace-pre-wrap">{description}</div>
				</div>
